<%@ Page Title="Kategori Ekle" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="TeknoBlog.Admin.Add._Category" %>

<asp:Content ID="Content1" ContentPlaceHolderID="AdminMainContent" runat="server">
    <div class="info success" runat="server" id="Info" visible="false">Kategori eklendi!</div>
