<%@ Page Title="İçeriği Düzenle" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeBehind="Content.aspx.cs" Inherits="TeknoBlog.Admin.Edit._Content" %>
<asp:Content ID="Content1" ContentPlaceHolderID="AdminMainContent" runat="server">
    <div class="info success" runat="server" id="Info" visible="false">İçerik düzenlendi!</div>
